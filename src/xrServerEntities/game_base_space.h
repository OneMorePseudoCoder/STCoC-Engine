...
enum EGamePlayerFlags
{
	...
	GAME_PLAYER_FLAG_SCRIPT_BEGINS_FROM	= (1<<3),
	GAME_PLAYER_FLAG_INVINCIBLE			= (1<<4),
	GAME_PLAYER_FLAG_ONBASE				= (1<<5),
	GAME_PLAYER_FLAG_SKIP				= (1<<6),
	GAME_PLAYER_HAS_ADMIN_RIGHTS		= (1<<7),
