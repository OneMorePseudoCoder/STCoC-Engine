...
CScriptIniFile::CScriptIniFile(LPCSTR szFileName, BOOL ReadOnly, BOOL bLoadAtStart, BOOL SaveAtEnd, LPCSTR path) : inherited(path ? path : update(szFileName), ReadOnly, bLoadAtStart, SaveAtEnd)
{}
...
{
    inherited::get_flags().set(eReadOnly, b);
}
